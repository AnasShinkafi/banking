    ...
    <div className='transactions'>
      <div className="transactions-header">
        <HeaderBox 
          ...
          subtext='See pagyour bank details and transactions.'
        />
      </div>
      ...
      <div className="space-y-6">
        <div className="transactions-account">
          <div className=" flex flex-col gap-2">
            ...
            <p className="text-14 font-semibold tracking-[1.1px] text-wrap">
          ...
          />
           {totalPage > 1 && (
                        <div className="my-4 w-full">
                            <Pagination page={currentPage} totalPages={totalPage} />
                        </div>
                    )}
        </section>
      </div>
